    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative">
          ...
          <div className="absolute left-5 md:left-1/2 md:-translate-x-1/2 top-0 w-1 h-full bg-cyan-500 rounded-full"></div>
          ...
          {education.map((item, index) => (
            ...
            >
              ...
              <div className="absolute left-5 md:left-1/2 md:-translate-x-1/2 z-10 w-12 h-12 rounded-full bg-cyan-500 flex items-center justify-center shadow-[0_0_25px_#06b6d4]">
                {item.icon}
              </div>
              ...
              <div className="ml-20 md:ml-0 md:w-5/12">
                <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 hover:border-cyan-500 hover:-translate-y-2 transition-all duration-300 hover:shadow-[0_0_25px_rgba(6,182,212,0.3)]">
