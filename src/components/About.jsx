      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16">
        ...
        <div className="w-full lg:w-1/2 flex justify-center order-1 lg:order-2">
          <div className="relative w-[300px] h-[420px] sm:w-[340px] sm:h-[470px] lg:w-[420px] lg:h-[560px]">
            ...
            {/* Cyan Background */}
            {/* <div className="absolute -right-4 -bottom-4 w-full h-full bg-cyan-500 rounded-3xl"></div> */}
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left order-2 lg:order-1">
          ...
          <p className="mt-8 text-gray-300 leading-8 text-lg">
            ...
            applications with clean UI and optimized backend architecture.
            My goal is to create fast, secure and user-friendly digital
          ...
          {/* Stats */}
          <div className="grid grid-cols-3 gap-5 mt-10 md:mx-0 mx-5">

            <div className="bg-slate-900 rounded-xl p-4 border border-slate-800 px-4">
